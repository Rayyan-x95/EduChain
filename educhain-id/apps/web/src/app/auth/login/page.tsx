...
export default function LoginPage() {
  ...
  return (
    <AuthLayout heading="Welcome back" subheading="Sign in to your EduChain ID account">
      {error && (
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-caption">
          <span className="bg-[var(--bg-default)] px-4 text-[var(--text-tertiary)]">or sign in with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 text-caption text-[var(--text-secondary)]">
            <input type="checkbox" className="rounded border-[var(--border-default)]" />
            Remember me
          </label>
          <Link href="/auth/forgot-password" className="text-caption text-[var(--color-primary)] hover:underline">
            Forgot password?
          </Link>
        </div>
